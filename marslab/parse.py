...
def instrument(fn,ptype='IMAGE'):
    ...
    if ptype=='IMAGE':
        return {
            'FL': "Front Hazcam Left (RCE-A)", 'FR': "Front Hazcam Right (RCE-A)",
            'FA': "Front Hazcam Anaglyph (RCE-A)", 'FG': "Front Hazcam Colorglyph (RCE-A)",
            'BL': "Front Hazcam Left (RCE-B)", 'BR': "Front Hazcam Right (RCE-B)",
            'BA': "Front Hazcam Anaglyph (RCE-B)", 'BG': "Front Hazcam Colorglyph (RCE-B)", 'CC': "Cache Cam",
            'EA': "EDL Parachute Uplook Cam A (PUC-A)", 'EB': "EDL Parachute Uplook Cam B (PUC-B)",
            'EC': "EDL Parachute Uplook Cam C (PUC-C)", 'ED': "EDL Rover Downlook Cam (RDC)",
            'EL': "EDL Lander Vision System (LVS)", 'ES': "EDL Descent Stage Downlook Cam (DSD)",
            'EU': "EDL Rover Uplook Cam (RUC)", 'HN': "Helicopter Navigation Cam",
            'HS': "Helicopter Return To Earth Cam", 'ZL': "Mastcam-Z Left", 'ZR': "Mastcam-Z Right",
            'ZA': "Mastcam Anaglyph", 'ZG': "Mastcam Colorglyph", 'WS': "MEDA Skycam", 'NL': "Navcam Left",
            'NR': "Navcam Right", 'NA': "Navcam Anaglyph", 'NG': "Navcam Colorglyph",
            'PC': "PIXL Micro Context Cam (MCC)", 'RL': "Rear Hazcam Left", 'RR': "Rear Hazcam Right",
            'RA': "Rear Hazcam Anaglyph", 'RG': "Rear Hazcam Colorglyph", 'SC': "SHERLOC Context Imager (ACI)",
            'SE': "SHERLOC Engineering (Imagers)", 'SI': "SHERLOC Imaging (Watson)",
            'SA': "SHERLOC Imaging (Watson) Anaglyph", 'SG': "SHERLOC Imaging (Watson) Colorglyph",
            'SL': "Watson treated as left-eye", 'SR': "Watson treated as right-eye", 'LR': "Supercam RMI",
            'WE': "MEDA Environment", 'OX': "MOXIE", 'PE': "PIXL Engineering", 'PS': "PIXL Spectrometer",
            'LS': "SuperCam Non-Imaging Data", 'SS': "SHERLOC Spectrometer", 'XM': "RIMFAX Mobile",
            'XS': "RIMFAX Stationary"}[fn[0:2]]
...
def get_ptype(fn): # get the product type
    try:
        return {
            54:"IMAGE",
            40:"MOSAIC"}[
                len(fn.split('.')[0])] # cut off the extension
    except:
        return "UNKNOWN"
...
def parse(fn):
    ...
    if ptype == 'IMAGE':
        fntable["SCLK"] = secondary_timestamp(fn) + tertiary_timestamp(fn) / 1000
